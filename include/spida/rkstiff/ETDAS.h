...
public:
    ...
    void setModeCutoff(double val)
    {
        m_mode_cutoff = val;
    }

    void setContourRadius(double val)
    {
        m_contour_radi = val;
    }

    void setContourPoints(unsigned val)
    {
        m_contourM = val;
    }

    double modeCutoff() const
    {
        return m_mode_cutoff;
    }

    double contourRadius() const
    {
        return m_contour_radi;
    }

    unsigned contourPoints() const
    {
        return m_contourM;
    }
...
private:
    ...
    std::vector<dcmplx> EL;
    std::vector<dcmplx> EL2;
    std::vector<dcmplx> N1;
    std::vector<dcmplx> N2;
    std::vector<dcmplx> N3;
    std::vector<dcmplx> N4;
    std::vector<dcmplx> N5;
    std::vector<dcmplx> tempK;
    std::vector<dcmplx> a21;
    std::vector<dcmplx> a31;
    std::vector<dcmplx> a32;
    std::vector<dcmplx> a41;
    std::vector<dcmplx> a43;
    std::vector<dcmplx> a51;
    std::vector<dcmplx> a52;
    std::vector<dcmplx> a54;
...
private:
    ...
    std::vector<dcmplx> N4;
    std::vector<dcmplx> N5;
    std::vector<dcmplx> N6;
    std::vector<dcmplx> N7;
    std::vector<dcmplx> tempK;
    std::vector<dcmplx> a21;
    std::vector<dcmplx> a31;
    std::vector<dcmplx> a32;
    ...
    std::vector<dcmplx> a52;
    std::vector<dcmplx> a54;
    std::vector<dcmplx> a61;
    std::vector<dcmplx> a62;
    std::vector<dcmplx> a63;
    std::vector<dcmplx> a65;
    std::vector<dcmplx> a71;
    std::vector<dcmplx> a73;
    std::vector<dcmplx> a74;
    std::vector<dcmplx> a75;
    std::vector<dcmplx> a76;
    ...
    void worker_stage7(const std::vector<dcmplx>& in,
