...
public:
    GridR(unsigned nr, double rmax) : m_nr(nr), m_rmax(rmax) {}
    ...
    void mirrorGrid(const std::vector<double>& in,
                    std::vector<double>& out,
                    bool signReverse = false) const;
    void mirrorGrid(const std::vector<dcmplx>& in,
