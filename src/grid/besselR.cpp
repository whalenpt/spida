...
BesselRootGridR::BesselRootGridR(unsigned nr,double maxr) : GridR(nr,maxr),
    m_r(nr), m_sr(nr)
{
    boost::math::cyl_bessel_j_zero<double>(0.0,1,static_cast<int>(nr),std::back_inserter(m_roots));
