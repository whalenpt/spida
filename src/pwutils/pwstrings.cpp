...
std::string eatWhiteSpace(const std::string& str, std::string delim, std::string fill)
{
...
std::vector<std::string> parseString(const std::string& mystr, const char delim)
{
    ...
    // If the delimiter character is not found, then add the input string to the output vector and
    // return
...
std::ostream&
columnOutput(std::ostream& os, std::string str, int st_col_num, int end_col_num, int init_col_num)
{
