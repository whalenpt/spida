...
const UniformGridCVX& SpidaCVX::getGridX() const
{
    return *m_gr;
}

FFTCVX& SpidaCVX::getTransformX()
{
    return *m_tr;
}

const std::vector<double>& SpidaCVX::getX() const
{
    return m_gr->getX();
}

const std::vector<double>& SpidaCVX::getSX() const
{
    return m_gr->getSX();
}

void SpidaCVX::X_To_SX(const std::vector<dcmplx>& in, std::vector<dcmplx>& out) noexcept
{
    m_tr->X_To_SX(in, out);
}

void SpidaCVX::SX_To_X(const std::vector<dcmplx>& in, std::vector<dcmplx>& out) noexcept
{
    m_tr->SX_To_X(in, out);
}
...
void SpidaCVX::dSX(const std::vector<dcmplx>& in,
