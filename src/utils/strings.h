...
std::string
eatWhiteSpace(const std::string& str, std::string delim = " \t", std::string fill = " ");
...
subStrings(const std::string& str, const char delim1 = '(', const char delim2 = ')');
...
std::string
removeSubStrings(const std::string& str, const char delim1 = '(', const char delim2 = ')');
std::string
removeSubString(const std::string& str, const char delim1 = '(', const char delim2 = ')');
